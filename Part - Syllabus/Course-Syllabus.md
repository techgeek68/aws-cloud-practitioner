...
- **Fact-checking.** Claims, numbers, service names, and console paths are checked against docs.aws.amazon.com, aws.amazon.com, and the current official exam guides. Anything that cannot be confirmed against an official source carries a short bracketed note in place.
- **Spelling.** US spelling throughout, matching AWS service names and documentation.
